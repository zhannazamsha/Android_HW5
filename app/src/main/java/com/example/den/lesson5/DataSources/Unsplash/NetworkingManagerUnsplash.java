...
public class NetworkingManagerUnsplash implements NetworkingManager {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                try {
                    ...
                    parseUnsplashResponse(jsonData, parser, gson, photoItems);
                } catch (Exception ex) {
    ...
    private void parseUnsplashResponse(String response, JsonParser parser, Gson gson, ArrayList<PhotoItem> photoItems) throws JSONException {
