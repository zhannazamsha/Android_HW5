...
import com.example.den.lesson5.Presenters.PhotoItemPresenterListView;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   NetworkingManager networkingManager = new NetworkingManagerUnsplash();
        ...
        PhotoItemsPresenter presenter = new PhotoItemPresenterListView();
    ...
    // TODO 4 - Create a new PhotoItemPresenterListView that implement PhotoItemsPresenter and shows images in ListView
